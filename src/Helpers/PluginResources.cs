namespace Loupedeck.LogicProPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LogicProPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LogicProPlugin.Resources.Resource.txt`.
