namespace Loupedeck.LogicProPlugin
{
    ...
    public static class LogicKeyCommands
    {
        ...
        public static readonly IReadOnlyList<LogicCommand> Commands = new List<LogicCommand>
        {
            ...
            new("GainUp", "Region Gain +1 dB *", "Edit", new(VirtualKeyCode.KeyG, Ctrl | Opt | Cmd | Shift)),
            new("GainDown", "Region Gain -1 dB *", "Edit", new(VirtualKeyCode.KeyH, Ctrl | Opt | Cmd | Shift)),
            new("GainUpFine", "Region Gain +0.1 dB *", "Edit", new(VirtualKeyCode.KeyJ, Ctrl | Opt | Cmd | Shift)),
